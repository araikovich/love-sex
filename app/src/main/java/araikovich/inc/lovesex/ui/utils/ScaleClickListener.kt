...
abstract class ScaleClickListener(private val duration: Long = DURATION,
        ...
        this.view?.let { view ->
            ...
            endAnimationListener = object : AnimatorListenerAdapter() {
                override fun onAnimationEnd(animation: Animator?) {
                    ...
                    onClick(this@ScaleClickListener.view?.get())
                }
            }

            upSet = AnimatorSet().apply {
                duration = this@ScaleClickListener.duration
    ...
    var touchEventCallback: ((event: MotionEvent?) -> (Unit))? = null
    ...
    override fun onTouch(v: View?, event: MotionEvent?): Boolean {
        ...
        return when (event?.action) {
            MotionEvent.ACTION_DOWN -> {
                touchEventCallback?.invoke(event)
                setVisibleRect()
